...
class EvaluatedJobOrm(Base):
    ...
    ai_match_score: Mapped[float | None] = mapped_column(Numeric, nullable=True)
...
class RunLogOrm(Base):
    ...
    account_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("accounts.account_id"))
    trigger_type: Mapped[TriggerType] = mapped_column(SqlEnum(TriggerType, name="trigger_type"))
    ...
    status: Mapped[RunStatus] = mapped_column(SqlEnum(RunStatus, name="run_status"))
    error_detail: Mapped[str | None] = mapped_column(Text, nullable=True)
    collection_capped: Mapped[bool] = mapped_column(Boolean, default=False)

    __table_args__ = (Index("ix_run_logs_account_started", "account_id", "started_at"),)
...
class CompanyScoreOrm(Base):
    ...
    weight_profile_id: Mapped[uuid.UUID | None] = mapped_column(nullable=True)
...
class JobPostingOrm(Base):
    ...
    workplace_type: Mapped[WorkplaceType | None] = mapped_column(
        SqlEnum(WorkplaceType, name="workplace_type"), nullable=True
    )
