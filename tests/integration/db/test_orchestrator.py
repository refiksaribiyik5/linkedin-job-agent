...
def test_session_invalid_error_persists_expired_status_despite_rollback(
    ...
    # Faz 13: "kalici bir oturum var" artik bir dosya-sistemi kontroludur
    # (bkz. session_manager.py modul dokumani) - `validate()`'in canli
    # kontrole (asagidaki basarisiz checker'a) ULASMASI icin profil dizini
    # GERCEKTEN diskte var olmalidir.
    ...
    session_manager = SessionManager(
        db_session,
        profile_root,
        lambda _user_data_dir: None,  # playwright_login - bu senaryoda hic cagrilmamali
        lambda _user_data_dir: False,  # session_validity_checker - gecersiz oturumu simule eder
